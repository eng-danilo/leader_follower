...
def generate_launch_description():
    ...
    leader_trajectory_eight = Node(
        package='qcar2_controller',
        executable='leader_trajectory_eight',
        name='leader_trajectory_eight',
    ...
    vrpn_client_launch = IncludeLaunchDescription(
     ...
     # Grouping all nodes under the qcar2_<number> namespace
     # This ensures that all topics and services are properly namespaced
     # according to the specific QCar instance being launched
     # e.g., /qcar2_2/GMPC, /qcar2_2/nav2_qcar2_converter, etc.
     # This is crucial for running multiple QCars simultaneously without topic/service conflicts
